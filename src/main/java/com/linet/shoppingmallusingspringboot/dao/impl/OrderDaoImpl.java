...
import com.linet.shoppingmallusingspringboot.rowmapper.OrderItemRowMapper;
import com.linet.shoppingmallusingspringboot.rowmapper.OrderRowMapper;
...
//
//            Map<String, Object> map = new HashMap<>();
//            map.put("orderId", orderId);//           map.put("productId", orderItem.getProductId());
